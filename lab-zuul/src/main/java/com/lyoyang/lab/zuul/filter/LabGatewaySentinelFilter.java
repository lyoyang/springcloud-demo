...
import com.lyoyang.lab.zuul.fallback.LabGatewayBlockFallbackProvider;
...
@Slf4j
@Configuration
public class LabGatewaySentinelFilter {
    ...
    @PostConstruct
    public void doInit() {
        ZuulBlockFallbackManager.registerProvider(new LabGatewayBlockFallbackProvider());
        initGatewayRules();
    }
